...
public class ChargingStationNegativeTest extends BaseTest {
    ...
    public void testChargingStation() {
        ...
        // Konum izni deny butonuna tıklıyoruz
        mainPage.clickDenyPermissionButton();  // Konum izni kabul edilmedi
        ...
        // En yakın istasyonların listelenmediği uyarısı al
